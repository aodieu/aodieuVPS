#!/bin/bash
#######################################################
# AodieuVPS Script v2.0.4 for CentOS 6
# To install type: 
# curl -sO https://aodieu.com/install && bash install
# or
# curl -sO https://aodieu.com/scripts/$(rpm -E %centos)/install && bash install
#######################################################
aodieuvps_version="2.0.4"
...
script_url="https://raw.githubusercontent.com/aodieu/aodieuVPS/master/scripts/6"
...
<hr><center>aodieuvps-nginx</center>
</body>
</html>
